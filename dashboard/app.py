...
st.caption("Synthetic GPU-fabric security simulation · attack paths · blast radius · anomaly analytics")
...
start_asset = st.sidebar.selectbox("Counterfactual start asset", sorted(twin.assets), index=sorted(twin.assets).index(default_start))
...
t1, t2, t3, t4, t5 = st.tabs(["Digital Twin", "Attack Path", "Risk & Telemetry", "Blast Radius", "Counterfactual Actions"])
...
st.divider()
st.caption("All assets, telemetry, attack paths, identities, workloads, and model artifacts are synthetic.")
